     ...
     <table class="striped" >
        <thead>
          <tr>
              ...
              <th data-field="id">Alterar (Status)</th>
        ...
        <tbody>
         <c:forEach var="produto" items="${produtos}" varStatus="status"> 
          <tr>
            ...
            <td><a href="EditaProdutoServlet?codigo=${produto.codigo}&nome=${produto.nome}"> <i class="small material-icons ">edit</i> </a></td>
            
            <td><a href="ExcluirProdutoServlet?codigo=${produto.codigo}"
          ...
          <tr>
             <br> <br>
             <a class="waves-effect waves-light waves-green btn"  href="formProduto.jsp">
