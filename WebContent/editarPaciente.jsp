...
<!-- ---------------------------------------------------------- -->
  ...
  <%
     ...
     Paciente paciente = pac.getPaciente(Integer.parseInt(request.getParameter("codigo")));
     pageContext.setAttribute("paciente",paciente);
 %> 

<div class="col container">
	<form action="EditaPacienteServlet" method="post" class="col container">

		<div class="row" align="center">
			<label for="login"><h5>Cadastro Paciente - ${paciente.nome} </h5></label>
		</div>

		<div class="row">
			<div class="input-field col s12">
				<input id="nome" type="text" name="nome" class="validate" value="${paciente.nome}"> <label
					for="nome">Nome</label>
			</div>
		</div>
		...
		<div class="row">
			<div class="input-field col s12">
				<input id="endereco" type="text" name="endereco" class="validate" value="${paciente.endereco}">
		...
		<div class="row">
			<div class="input-field col s6">
			 <i class="material-icons prefix">phone</i>
				<input id="telefone" type="text"  name="telefone" value="${paciente.telefone}" > <label for="icon_telephone">Telefone</label>
			</div>
		</div>

		    <div class="row">
			<div class="input-field col s6">
				<input id="CPF" type="text" name="CPF" value="${paciente.cpf}" maxlength="11" size="11" length="11" >
			    <label for="CPF"> CPF (sem ponto) </label> <font  color="red">  ${param.erro}</font>
			</div>
			
			<div class="input-field col s6">
			
				<input id="RG" type="text" name="RG" class="RG" value="${paciente.rg}" maxlength="11" size="11" length="11">
