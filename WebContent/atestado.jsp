       ...
       <li class="logo">
        ...
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">Atendimentos</a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="atendimentos.jsp?nome=${user.nome}" class="waves-effect waves-light waves-red" >Prontuário Médico</a></li>
...
Atesto, que o Sr(a) ${nome} por motivo de doença _______________________________	                                      
		deverá manter-se em repouso  por ____ dia(s) a partir da presente data.
