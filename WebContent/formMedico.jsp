...
<div class="col container">
	<form action="AdicionaMedicoServlet" method="post" class="col container">

		<div class="row" align="center">
			<label for="login"><h5>Cadastro Médico</h5></label>
		</div>
		...
		<div class="row">
			...
			<div class="input-field col s6">
				...
				<input id="especialidade" type="text" name="especialidade" class="validate">
