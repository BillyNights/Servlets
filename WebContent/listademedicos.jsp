<%@page import="br.ifmg.trabalhopratico01.negocio.MedicoDAO"%>
...
<%
   ...
   if (request.getParameter("buscar").equals("todos")) {
	     medicos = dao.getMedicos();
	     pageContext.setAttribute("medicos",medicos);
	  }
  else {
    	 medicos = dao.getNomeMedicos(request.getParameter("buscar"));
         pageContext.setAttribute("medicos",medicos);
      }
        ...
        <tbody>
         <c:forEach var="medico" items="${medicos}" varStatus="status"> 
          <tr>
            ...
            <td><a href="editarMedico.jsp?codigo=${medico.codigo}"
             onclick=" return confirm('Clique em Ok para editar.')"> <i class="small material-icons ">edit</i> </a></td>
            
            <td><a href="ExcluirMedicoServlet?codigo=${medico.codigo}"
          ...
          <tr>
             <br> <br>
             <a class="waves-effect waves-light waves-green btn"  href="formMedico.jsp">
