...
<div class="col container">
	<form action="AdicionaUsuarioServlet" method="post"
		class="col container">

		<div class="row" align="center">
			<label for="login"><h5>Cadastro Usuário</h5></label>
		</div>
		...
		<div class="row">
			<div class="input-field col s6">
				<input id="senha1" type="password" maxlength="8" size="8"
					name="senha" length="8"> <label for="senha1">Senha</label>
			</div>
		</div>

		<div class="row">
			<div class="input-field col s6">
				<input id="senha2" type="password" maxlength="8" size="8"
