...
<body>
 ...
 <% 
         ...
         List<TADListaPacientesHoje> lista;  
         
          
    	 lista = dao.getConsultasporDataMedico(dataS,request.getParameter("nome"));
    	 pageContext.setAttribute("listas",lista);
  ...
  <div class="row">
     <table class="striped" >
        ...
        <tbody>
          ...
          <c:forEach var="lista" items="${listas}" varStatus="status"> 
          <tr>
            <td> <a href="verPreconsulta.jsp?codigo=${lista.codigo}&nome=${lista.nome}&codAgenda=${lista.codAgenda}"> ${lista.codigo}</td>
            <td> <a href="verPreconsulta.jsp?codigo=${lista.codigo}&nome=${lista.nome}&codAgenda=${lista.codAgenda}"> ${lista.nome}</td>
            <td> <a href="verPreconsulta.jsp?codigo=${lista.codigo}&nome=${lista.nome}&codAgenda=${lista.codAgenda}"> ${lista.horario}</td>
          </tr>
