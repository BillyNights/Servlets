...
protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    	 ...
	    	 Boolean erro = med.insertMedico(new Medico(-1, req.getParameter("nome"), req.getParameter("endereco"), req.getParameter("telefone"), req.getParameter("crm"),req.getParameter("especialidade")));
