...
protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	 ...
	 if(validaCpf(cpf)){
			 ...
			 Boolean erro = pac.updatePaciente(new Paciente(Integer.parseInt(req.getParameter("codigo")), req.getParameter("nome"), req.getParameter("CPF"), req.getParameter("RG"), req.getParameter("endereco"),req.getParameter("telefone")));
